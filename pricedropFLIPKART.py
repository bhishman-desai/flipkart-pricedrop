...
def check_price():
    ...
    for x in soup_list:
        title_list.append(x.find("span", {"class": "_35KyD6"}).get_text())
        price_list.append(float(x.find("div", {"class": "_1vC4OE _3qQ9m1"}).get_text()[1:].replace(',', '')))
